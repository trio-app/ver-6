...
//            $.ajax("/secure/url/for/sign-message?request=" + toSign).then(resolve, reject);
    ...
    function startConnection(config) {
        ...
        if (!qz.websocket.isActive()) {
            ...
            Ext.getCmp('print_tbar').setValue('<span style="color:red">Disconnected</span>');

            qz.websocket.connect(config).then(function() {
                //updateState('Active', 'success');
                Ext.getCmp('print_tbar').setValue('<span style="color:green">QZ Connected</span>')
                findVersion();
    ...
    function findDefaultPrinter(set) {
        qz.printers.getDefault().then(function(data) {
            Ext.toast({
                html: '<strong>Default Printer : </strong><br/>' + data,
                title: 'Notification',
                width: 200,
                align: 'tr',
            ...
            Ext.getCmp('print_conn').setValue('<span style="color:green">'+ data + '</span>');
