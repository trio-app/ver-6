  Ext.define('SystemAsset.Cpgroup.controller.C_cpgroup', {
    extend  : 'Ext.app.Controller',
    init: function () {
        this.control({
            'FRM_cpgroup button[action=add]': {
    ...
    onRowdblclick: function(me, record, item, index){
        var form = Ext.getCmp('FRM_cpgroup').down('form');
    ...
    doSaveform: function(){
        ...
        var recValue = Ext.create('SystemAsset.Cpgroup.model.M_cpgroup', values);
        console.log(action);
        if(action == 'edit') {
    ...
    doProsesCRUD : function (inAction,record){
        var grid = Ext.getCmp('GRID_cpgroup');
        var form = Ext.getCmp('FRM_cpgroup');
        var store = grid.getStore();//Ext.getStore('SystemAsset.Assetpic.store.STassetpic');;//
        console.log(record.data);
        Ext.Ajax.request({
                    url: base_url + 'Cpgroup/' +  inAction,
                    method: 'POST',
                    //type:'json',
